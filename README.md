...
*Обработка:* retries=2, проверка структуры
...
- Отправка уведомлений на почту в случае сбоя выполнения DAG: данный шаг является примером дальнейшего улучшения и развития проекта.
